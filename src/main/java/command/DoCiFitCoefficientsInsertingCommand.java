...
public class DoCiFitCoefficientsInsertingCommand implements Command
{
	private final static int FITTING_METHOD_NUMBER = 2; 
	@Override
	...
	private void updateFit(final long transPk, final double[] coeffs, final int iMethod)
	{
		try 
		{
			...
			dbManager.insertCiFitCoefficients(transPk, coeffs, iMethod);
		} 
