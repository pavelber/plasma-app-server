...
public class DoCrmRalchenkoStructureCommand implements Command
{
	@Override
	...
	private void makeFile(final int iCalcId, 
			final int iAiStateInitialNumber, final PrintWriter p, final String sFileName)
	{
		try 
		{
			...
			Ralchenko ralchenko = new Ralchenko(calc, factory);
			ralchenko.writeStructure(directoryName + FileConstants.SEPARATOR + sFileName);
