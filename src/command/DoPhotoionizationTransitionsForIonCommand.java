...
public class DoPhotoionizationTransitionsForIonCommand implements Command
{
	...
	throws ServletException, IOException 
	{
		...
		{ 
			...
			Response responseContent = execute(iCalcId, iIonCharge);
	...
	private Response execute(final int iCalcId, final int iIonCharge)
	{
		Response res = null;
		DbManager dbManager = new DbManager();
		res = onTransitionsRequest(dbManager, iCalcId, iIonCharge);
		//System.out.println(res.toString());
		return res;
	}
	
	private Response onTransitionsRequest(final DbManager dbManager, 
			final int iCalcId, final int iIonCharge)
	{
		Calc calc = dbManager.getPhotoionizationTransitionsForIon(iCalcId, iIonCharge);
