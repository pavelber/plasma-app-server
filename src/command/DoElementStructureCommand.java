...
public class DoElementStructureCommand implements Command
{
	...
	private Response execute(final int iCalcId)
	{
		...
		res = onCalcRequest(dbManager, iCalcId);
		System.out.println(res.toString());
		return res;
	}
	
	private Response onCalcRequest(final DbManager dbManager, final int iCalcId)
	{
		Calc calc = dbManager.getStructure(iCalcId);
        Response response = new Response();
        response.setName("calc");
