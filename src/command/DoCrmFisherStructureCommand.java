...
public class DoCrmFisherStructureCommand implements Command
{
    @Override
...
//          theException.printStackTrace(); 
            ...
            final int iAiStateInitialNumber, final PrintWriter p, final String sFileName)
    {
        try 
        {
            ...
            Fisher fisher = new Fisher(calc, factory);
            fisher.writeStructure(directoryName + FileConstants.SEPARATOR + sFileName);
